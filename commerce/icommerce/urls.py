...
urlpatterns = patterns('',
    ...
    # Botiga marca list, ex.: /icommerce/marcas.json
    url(r'^marcas\.(?P<extension>(json|xml|html))$', MarcaList.as_view(),name='marca_list'),
    ...
    # Botiga marca details, ex.:  /icommerce/marcas/1.json
